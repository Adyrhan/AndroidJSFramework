...
public class CameraManagerActivity extends Activity {
	/**
	 * Activity result value returned when no camera app is installed
	 */
	public static final int RESULT_NO_CAMERA_APP_INSTALLED = 1;
	/**
	 * Activity result value returned when an unexpected error happened
	 */
	public static final int RESULT_UNEXPECTED_ERROR = 3;
	/**
	 * Activity result value returned when it wasn't possible to store the picture
	 */

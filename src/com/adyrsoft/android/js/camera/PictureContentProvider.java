...
/**
 * This ContentProvider allows a safe access to the local file system from the webview, allowing to only access the file located in PictureContentProvider.TEMPORAL_FILE_PATH through PictureContentProvider.TEMPORAL_FILE_URI .
 * The authority that handles the content:// type of uri schema is 'com.adyrsoft' and must be defined when declaring this ContentProvider in your project's AndroidManifest file.
 * @author Adrián Pérez
 *
 */
